  ...
  return createPortal(
    ...
    >
      ...
      >
        ...
        <div className="pt-4 border-t border-gray-200 dark:border-white/[0.08] flex items-center justify-center gap-1 text-sm font-medium text-gray-500 dark:text-gray-400">
          ...
          基于 <a href="https://github.com/CookSleep/gpt_image_playground" target="_blank" rel="noopener noreferrer" className="hover:text-gray-900 dark:hover:text-gray-100 transition-colors underline underline-offset-4">@CookSleep</a> 构建，由 <a href="https://github.com/plaidwork/gpt_image_playground" target="_blank" rel="noopener noreferrer" className="hover:text-gray-900 dark:hover:text-gray-100 transition-colors underline underline-offset-4">@plaidwork</a> 深度定制
        </div>
      </div>
    </div>,
    document.body
